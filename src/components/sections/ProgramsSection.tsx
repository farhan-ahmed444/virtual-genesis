    ...
    <section className="py-24 md:py-32 bg-neutral">
      <div className="max-w-7xl mx-auto px-6">
        <AnimatedSection className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div>
            <p className="text-sm font-semibold text-[#2DBEFF] uppercase tracking-widest mb-2">Programs</p>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {programs.map((program, i) => (
            <AnimatedSection key={program.id} delay={i * 0.1}>
              <div className="group bg-white rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-[#2DBEFF]/5 transition-all duration-500 hover:-translate-y-1">
                ...
                <div className="p-5">
                  <h3 className="font-heading font-bold text-lg mb-2 group-hover:text-[#2DBEFF] transition-colors">
                    {program.title}
                  </h3>
